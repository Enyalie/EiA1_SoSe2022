var course: HTMLElement = document.getElementById("course");
...
function newSentence(){
    ...
    if(currentPositioninCourse==null) currentPositioninCourse= 0;
    else currentPositioninCourse= currentPositioninCourse+1;

    document.getElementById("deutscherSatz").innerHTML = saetzePars[currentPositioninCourse].satzDeutsch.join("");
    var Spain:String[]=[...saetzePars[currentPositioninCourse].satzSpanisch];
    schuffleArray(Spain);
...
if(rigthWords===saetzePars[currentPositioninCourse].satzSpanisch.length -1) newSentence();
    }
     else{
alert ("Wrong Word");
