...
console.log("[IR] Gesamtzahl Einwohnerinnen und Einwohner in der Schweiz in 2022: " + schw2022 + " Mio.");
console.log("[IR] Im Verhältnis zur Gesamtzahl in der EU: " + verhältnisSCHW.toFixed(2) + "%");
console.log("[IR] Wachstumsrate in der Schweiz seit 2010 : " + wachstumSCHW.toFixed(2) + "%");
console.log("[IR] Wachstumsrate gesamt in der Schweiz seit 2010: " + wachstumSCHWges + " Mio.");
